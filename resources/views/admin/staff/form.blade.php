                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="" action="{{ route('admin.staff.store') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">

                                    <x-admin.form-group label="name" class="mb-3" placeholder="Enter staff name"
                                        column="col-lg-6" required /><br />

                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="" class="form-label">নাম <span class="text-danger">*</span></label>
                                            <input type="text" name="name_bn" class="form-control"  placeholder="ইন্টার স্টাফ নাম" required>
                                            <span class="text-danger"></span>
                                        </div>
                                    </div>

                                    {{-- <x-admin.form-group label="email" class="mb-3" placeholder="Enter staff email"
                                        column="col-lg-4" /><br/> --}}


                                    <x-admin.form-group label="designation" class="mb-3" placeholder="Enter staff designation"
                                         column="col-lg-6"  required/><br />
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                <label for="" class="form-label">পদবী <span class="text-danger"> *</span></label>
                                                <input type="text" name="designation_bn" class="form-control"  placeholder="ইন্টার পদবী" required/>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
