                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <p class="font-size-16">Members</p>
                    ...
                    <div class="col-xl-3 col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <p class="font-size-16">Staff</p>
                                    <div class="mini-stat-icon mx-auto mb-4 mt-3">
                                        <span class="avatar-title rounded-circle bg-soft-success">
                                                <i class="mdi mdi-account-outline text-success font-size-20"></i>
                                            </span>
                                    </div>
                                    <h5 class="font-size-22">{{ count($staffs) }}</h5>
                                    ...
                                    <div class="" style="">
                                        ...
                                        <a href="{{ route('admin.staff.index') }}" class="btn btn-dark">Show</a>
                                    </div>
                                </div>
                            </div>
                        </div>
