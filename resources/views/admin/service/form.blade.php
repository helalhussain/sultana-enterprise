...
@section('admin_content')
    <x-admin.page-title dashboard_title="Admin" title="service" page_name="Add service">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="" action="{{ route('admin.service.store') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">

                                    <x-admin.form-group label="name" class="mb-3" placeholder="Enter service name"
                                    ...
                                    <x-admin.form-group label="logo" for="logo" class="mb-3" :required="false"
                                        type="file" data-show-image="show_service_image" column="col-lg-4" />

                                        <label for="" class="form-label">About<span
                                            class="text-danger">*</span></label>
